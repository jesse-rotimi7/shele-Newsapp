  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
      <div className="relative mb-8">
        <div className={`absolute inset-0 rounded-3xl blur-2xl ${isError ? "bg-rose-500/20" : "bg-[var(--color-ink)]/5"}`} />
        <div className={`relative w-24 h-24 rounded-3xl grid place-items-center ${isError ? "bg-[var(--color-primary-light)]" : "bg-[var(--color-surface-alt)]"}`}>
          {isError ? (
